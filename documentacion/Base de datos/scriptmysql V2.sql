...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-05-2020 a las 01:13:41
...
CREATE TABLE `documento` (
  ...
  `TipodeDocumento` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `personas` (`ROL_idROL`, `idPersonas`, `Nombre`, `Apellidos`, `Celular`, `Direccion`, `Correo`, `Usuario`, `Contrasena`, `token`, `Documento_idDocumento`, `nro_documento`) VALUES
(2, 1, 'Lorena', '	Ramirez', 432423, 'KR 88', 'LORENA@GMAIL.COM', 'LORENA22', 'ed265bc903a5a097f61d3ec064d96d2e', 'CXGBmQQwCn', NULL, NULL),
(2, 2, 'Fabio', '	Ortega', 234234, '	KR 66	', 'FABIO@GMAIL.COM', 'FABIO65', '81dc9bdb52d04dc20036dbd8313ed055', NULL, NULL, NULL),
(2, 3, 'LAURA', '	OCHOA', 788652, 'KR 100', 'LAURA@GMAIL.COM', 'LAURA90', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL),
(2, 5, 'CAMILA', '	PEREZ', 565656, 'KR 01', 'CAMILA@GMAIL.COM', 'CAMILA72', '1234567', NULL, NULL, NULL),
(1, 6, 'ZULLY', 'TAMAYO', 845484, 'KR 20 13', 'zullytamayom@gmail.com', 'ZULLY72', '797ea64fe9f01f635de1fda6d3c450f1', NULL, NULL, NULL),
(3, 7, 'SEBASTIAN', '	RODRIGUEZ', 4555, 'KR 23 45', 'SEBASTIAN@GMAIL.COM', 'SEBASTIAN72', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL),
(3, 8, 'FREDDY', 'RAMOS', 46346347, 'KR 45 60', 'FREDDY@GMAIL.COM', 'FREDDY72', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL),
(2, 12, 'tatiana', 'arias perez', 12149249489, 'cl 12 12 12', 'tatiana@gmail.com', 'tati10', 'ec6a6536ca304edf844d1d248a4f08dc', NULL, NULL, NULL),
(2, 13, 'Heiver', 'Cuesta', 34232145, 'cr 30', 'heiver@gmail.com', 'heiver', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL),
(3, 16, 'Camilo', 'Medina', 313223, 'cl 161', 'camilomedina@gmail.com', 'cami83', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL),
(2, 17, 'yineth', 'martinez', 312441, 'cl 67 67', 'yineth@gmail.com', 'yineth1', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL),
(2, 19, 'Lilia', 'Martinez gongora', 3132948318, 'carrera 8 no 17-42 casa 2 fundadores', 'limartigo@hotmail.com', 'lilimar', '827ccb0eea8a706c4c34a16891f84e7b', 'o12dsVk9u9', NULL, NULL),
(2, 20, 'tatiana', 'arias perez', 12149249489, 'cl 12 12 12', 'tatiana@gmail.com', 'tati10', 'ec6a6536ca304edf844d1d248a4f08dc', NULL, NULL, NULL),
(3, 21, 'Felipe', 'Arias', 31415355, 'CL 3 NO 4 5', 'felipe@gmail.com', 'pipelon', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL),
(2, 22, 'Gustavo Francisco', 'Petro Urrego', 414253425, 'cl 45 45 45 ', 'gustavou@gmail.com', 'gus10', '827ccb0eea8a706c4c34a16891f84e7b', NULL, NULL, NULL),
(3, 24, 'Daniela', 'Ñañez', 3149358357, 'cl 34 45 56 ', 'daniela@gmail.com', 'dani23', 'd9b1d7db4cd6e70935368a1efb10e377', NULL, NULL, NULL),
(2, 25, 'nayibe', 'sanchez', 31248584, 'cl 12 3 2', 'nayibe@gmail.com', 'nayibe1', '81dc9bdb52d04dc20036dbd8313ed055', NULL, NULL, NULL),
(3, 27, 'kiko', 'jul', 7632573, '3', 'kiko@gmail.com', 'kiko2', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL),
(3, 38, 'prueba', 'mayo', 314244, 'cl 12 3 2m', 'daniela@gmail.com', 'dani22', 'c8b2f17833a4c73bb20f88876219ddcd', NULL, 1, NULL),
(3, 39, 'nayibe noa', 'tellez', 312315, 'cl 34 45 56 ', 'nayibe2@gmail.com', 'nayibe12', '202cb962ac59075b964b07152d234b70', NULL, 3, NULL),
(3, 40, 'yano', 'lola', 325432743875, 'cl 34 45 56 ', 'kiko@gmail.com', 'gide', '202cb962ac59075b964b07152d234b70', NULL, 2, 2147483647),
(3, 41, 'yano', 'lola', 325432743875, 'cl 34 45 56 ', 'kiko@gmail.com', 'gide', '202cb962ac59075b964b07152d234b70', NULL, 2, 2147483647),
(3, 42, 'yano', 'lola', 325432743875, 'cl 34 45 56 ', 'kiko@gmail.com', 'gide', '202cb962ac59075b964b07152d234b70', NULL, 2, 2147483647),
(2, 43, 'ww', 'Ñañez', 11111, 'cl 56', 'leidyjjj@gmail.com', '2', 'eccbc87e4b5ce2fe28308fd9f2a7baf3', NULL, 2, 2147483647),
(2, 44, 'ww', 'Ñañez', 11111, 'cl 56', 'leidyjjj@gmail.com', '2', 'eccbc87e4b5ce2fe28308fd9f2a7baf3', NULL, 2, 2147483647),
(3, 45, 'prueba', 'mayo', 314244, 'cl 12 3 2m', 'daniela@gmail.com', 'dani22', 'c8b2f17833a4c73bb20f88876219ddcd', NULL, 1, 777777776),
(3, 46, 'kikokiko2', 'sanchez', 31248584, 'cl 12 3 2', 'kiko2@gmail.com', 'kikokk', '81dc9bdb52d04dc20036dbd8313ed055', NULL, 1, 2147483647);
...
--
ALTER TABLE `personas`
  MODIFY `idPersonas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT de la tabla `reservas`
--
ALTER TABLE `reservas`
  MODIFY `idRESERVAS` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador de la reserva', AUTO_INCREMENT=52;
...
ALTER TABLE `personas`
  ...
  ADD CONSTRAINT `personas_ibfk_2` FOREIGN KEY (`Documento_idDocumento`) REFERENCES `documento` (`idDocumento`);
